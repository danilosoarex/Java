...
public interface SerieRepository extends JpaRepository<Serie, Long> {
    ...
    List<Serie> findByTituloContainingIgnoreCaseAndAtoresContainingIgnoreCaseAndAvaliacaoGreaterThanEqual(String nomeSerie, String nomeAutor, Double avaliacao);
